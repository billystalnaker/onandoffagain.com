...
<div class="js_var">
    ...
    <span id="marker_get_api_url"><?php echo site_url('api/get_markers') ?></span>
    <span id="marker_update_api_url"><?php echo site_url('api/update_marker') ?></span>
    <span id="marker_insert_api_url"><?php echo site_url('api/insert_marker') ?></span>
    <span id="defect_get_api_url"><?php echo site_url('api/get_defects') ?></span>
    <span id="st_light_defect_get_api_url"><?php echo site_url('api/get_st_light_defects') ?></span>
</div>
...
<script type="text/javascript">
	...
	google.maps.event.addListener(element, 'click', function() {
		...
		$.post($('#defect_get_api_url').text(), function(data) {
			...
			$('.update_st_light_form  [name="update[' + element.id + '][new_comment]"]').val(st_light_defects[element.id]);
			$('.update_st_light_form  [name="update[' + element.id + '][current__comment]"]').val(st_light_defects[element.id]);
		    });
		});
	    });
