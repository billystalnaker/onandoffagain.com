...
<form action="<?php echo current_url(); ?>" method="POST" class="insert_st_light_form">
	...
	<div class="col-md-6">
		...
		<div class="input-group col-md-9">
		    ...
		    <input class="form-control st_light_lat_loc" type="text" value="<?php echo set_value('insert_st_light_lat_loc') ?>" name="insert_st_light_lat_loc">
		</div>
	    </div>
	    <div class="form-group row">
		...
		<div class="input-group col-md-9">
		    <span class="input-group-addon"><i class="fa-map-marker fa"></i></span>
		    <input class="form-control st_light_long_loc" type="text" value="<?php echo set_value('insert_st_light_long_loc') ?>" name="insert_st_light_long_loc">
		</div>
	    </div>
	    <div class="form-group row">
