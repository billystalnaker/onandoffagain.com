                            ...
                            <tbody>
                                <?php foreach($defects as $defect){ ?>
                                    <tr>
                                        ...
                                        <td>
                                            <textarea cols="75" rows="3"name="update[<?php echo $defect['id']; ?>][comment]"><?php echo(isset($st_light_defects[$defect['id']]) && $st_light_defects[$defect['id']] != '')?$st_light_defects[$defect['id']]:''; ?></textarea>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
