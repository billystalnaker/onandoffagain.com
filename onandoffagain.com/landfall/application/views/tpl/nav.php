							...
							<div class="input-group-btn">
								...
								<ul id="search_choices" class="dropdown-menu" role="menu">
									<?php if($this->flexi_auth->is_privileged('Users')){ ?>
										<li data-choice="user_accounts"><a href="#">Users</a></li>
									<?php } ?>
									<?php if($this->flexi_auth->is_privileged('Privileges')){ ?>
										<li data-choice="user_privileges"><a href="#">Privileges</a></li>
									<?php } ?>
									...
									<?php if($this->flexi_auth->is_privileged('Defects')){ ?>
										<li data-choice="defect"><a href="#">Defects</a></li>
									<?php } ?>
									<?php if($this->flexi_auth->is_privileged('Defect Types')){ ?>
										<li data-choice="defect_type"><a href="#">Defect Types</a></li>
									<?php } ?>
									<!--    				<li class="divider"></li>-->
								</ul>
							</div>
