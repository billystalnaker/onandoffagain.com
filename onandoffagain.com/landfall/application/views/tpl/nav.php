    	...
    	<div class="sidebar-collapse">
    		...
    		<li class="sidebar-search">
    			...
    			<div class="input-group-btn">
					...
					<li data-choice="st_light"><a href="javascript:void(0);">St. Lights</a></li>
				    <?php } ?>
				    <?php if($this->flexi_auth->is_privileged('Defects')){ ?>
					<li data-choice="defect"><a href="javascript:void(0);">Defects</a></li>
				    <?php } ?>
				    <?php if($this->flexi_auth->is_privileged('Defect Types')){ ?>
					<li data-choice="defect_type"><a href="javascript:void(0);">Defect Types</a></li>
				    <?php } ?>
    				<!--    				<li class="divider"></li>-->
    			    </ul>
    			</div>
